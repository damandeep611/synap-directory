...
export default function ArticleCard({ title, description, url, imageUrl, createdAt }: ArticleCardProps) {
  ...
  return (
    <a
      ...
      className="group flex flex-col h-120 bg-[#050505] rounded-xl overflow-hidden border border-white/10 hover:border-white/20 transition-all duration-300 shadow-2xl"
    >
      ...
      <div className="relative h-[55%] w-full overflow-hidden bg-white/5">
        {imageUrl ? (
          ...
          <div className="w-full h-full flex items-center justify-center bg-linear-to-br from-purple-900/20 to-black">
