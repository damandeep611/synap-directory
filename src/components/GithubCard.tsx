...
export default function GithubCard({ title, description, url, imageUrl, tags = [] }: GithubCardProps) {
  ...
  return (
    <a
      ...
      className="group relative flex flex-col h-105 w-full bg-[#050505] rounded-xl border border-white/10 overflow-hidden transition-all duration-300 hover:border-white/20 hover:shadow-2xl hover:shadow-blue-900/5"
    >
      {/* Top Image Section */}
