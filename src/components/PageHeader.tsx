...
const PageHeader: React.FC<PageHeaderProps> = ({
  ...
  return (
    <section className="relative w-full pt-10 pb-12 px-6 md:px-8 overflow-hidden bg-[#050505] border-b border-white/5">
      {/* Subtle Background Gradients - Reduced opacity and size */}
      ...
      <div className="relative max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-[1fr_320px] gap-8 lg:gap-16 items-center">
        ...
        >
          ...
          <div className="flex items-center gap-2 text-[11px] font-medium tracking-wide mb-4">
            ...
            <span className="text-white/30 uppercase tracking-wider">{category}</span>
            <span className="text-white/10">/</span>
            <span className="text-white/80 uppercase tracking-wider">{title}</span>
          </div>
        ...
        >
          {/* Glow effect */}
          <div className="absolute -inset-1 bg-gradient-to-tr from-white/10 via-white/5 to-transparent rounded-2xl blur-lg opacity-30" />
          
          <div className="relative aspect-[16/9] w-full bg-neutral-900/50 backdrop-blur-sm border border-white/5 rounded-2xl p-1.5 ring-1 ring-white/5 overflow-hidden">
             {/* Inner Card Content */}
             <div className="h-full w-full bg-[#0A0A0A] rounded-xl border border-white/5 relative overflow-hidden flex flex-col p-5">
                ...
                <div className="relative z-10 flex-1 flex flex-col justify-between">
                  ...
                  <div className="pt-4 mt-auto border-t border-white/5 flex justify-between items-end">
                      <div>
                        <div className="text-[9px] uppercase tracking-widest text-white/20 font-bold mb-0.5">Status</div>
