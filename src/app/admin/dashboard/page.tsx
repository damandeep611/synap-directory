  ...
  const handleMarkdownSave = async (e: React.FormEvent) => {
    ...
    try {
        ...
        if (result.success) {
            ...
            setMdFormData({ title: "", description: "", content: "" });
        } else {
                  ...
                  <div className="flex items-center justify-between mb-8">
                    ...
                    <div className="bg-white/5 p-1 rounded-lg flex items-center">
                        <button 
                            ...
                            className={`px-3 py-1.5 rounded-md text-xs font-medium transition-all flex items-center gap-2 ${resourceType === 'link' ? 'bg-white/10 text-white shadow-sm' : 'text-white/40 hover:text-white'}`}
                        >
                        ...
                        <button 
                            ...
                            className={`px-3 py-1.5 rounded-md text-xs font-medium transition-all flex items-center gap-2 ${resourceType === 'markdown' ? 'bg-white/10 text-white shadow-sm' : 'text-white/40 hover:text-white'}`}
                        >
                              ...
                              <div className="relative">
                                ...
                                >
                                  {categories.length === 0 ? (
                                    ...
                                    categories.filter(c => c.slug !== 'md').map((cat) => (
                                      <option
                                        key={cat.id}
                                        value={cat.id}
                                        className="bg-black"
                    ...
                    <form className="space-y-6" onSubmit={handleMarkdownSave}>
                        <div className="space-y-2">
                            ...
                            <input
                                ...
                                onChange={(e) => setMdFormData({...mdFormData, title: e.target.value})}
                        ...
                        <div className="space-y-2">
                            ...
                            <input
                                ...
                                onChange={(e) => setMdFormData({...mdFormData, description: e.target.value})}
                        ...
                        <div className="space-y-2">
                            ...
                            <textarea
                                ...
                                onChange={(e) => setMdFormData({...mdFormData, content: e.target.value})}
                                rows={10}
